...
//////////////////////////////////////////////////
      ...
      /*
  Creates the first audit-history record
  for the newly created task.

  The history is generated by the backend,
  not by the frontend.
*/
...
export const updateTask = async (
  ...
  try {
    ...
    */
    ...
    /*
      Saves the old task values before updating.

      We need these values so the backend can
      compare the old and new values and create
      audit-history records only for fields
    ...
    */
    ...
    /*
      Creates an audit record only if
      the task title actually changed.
    */
    if (
      oldTitle !== task.title
    ) {
    ...
    */
    ...
    /*
      Status changes have their own action type
      and store both the old and new status.
    */
    if (
    ...
    */
    ...
    /*
      Creates an audit record only if
      the estimated time actually changed.

      Audit values are stored as text,
    ...
    */
    if (
      ...
      await TaskAudit.create({
        ...
        oldValue:
          oldEstimatedMinutes !== null
            ? String(oldEstimatedMinutes)
            : null,
