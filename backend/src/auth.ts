...
authRouter.post(
  ...
  async (
    ...
    try {
      // this is a post end point and post is used because login sends private data in the request body 
      ...
      logger.info(
  `User ${existingUser.id} logged in successfully` // this is the message parameter in logger
);
...
authRouter.post(
  ...
  async (
    ...
    try {
      ...
      logger.info(
  `User ${newUser.id} signed up successfully` // this is the message parameter in logger
);
...
authRouter.get(
  ...
  async (
    ...
    try {
      //creates the current user endpoint 
